...
According to our observation, during the HGP project period (1990-2003), the ratio of direct and mediate $XD$ collaboration steadily keeps having a mild increase. The effectiveness of that collaboration only remarkably exhibits from 2005 to later when the number of mediate links increases sharply. This can be explained by the robustness of the internal network of each individual affiliation and the development of the cross-disciplinary links.
