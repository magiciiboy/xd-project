...
\SweaveInput{./sections/contribution2.Rnw}

\newpage
\section{Figure 4}
\SweaveInput{./sections/section4.Rnw}

\newpage
\section{Supplementary Table S2}
\SweaveInput{./sections/sectionT2.Rnw}

\newpage
\section{Supplementary Table S3}
\SweaveInput{./sections/sectionT3.Rnw}

\newpage
\section{Supplementary Table S4}
\SweaveInput{./sections/sectionT4.Rnw}

\newpage
\section{Supplementary Table S5}
\SweaveInput{./sections/sectionT5.Rnw}
